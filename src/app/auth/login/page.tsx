  ...
  return (
    <div className="min-h-screen flex bg-[var(--background)]">
      ...
      <div className="hidden lg:block w-1/2 relative">
        ...
        <div className="absolute bottom-10 left-10 p-8 text-white z-10">
          <h1 className="text-4xl font-bold mb-4 font-[family-name:var(--font-geist-sans)]">Drive the Extraordinary.</h1>
          <p className="text-lg opacity-90 max-w-md">Experience the thrill of the world's most exclusive fleet. Your journey begins here.</p>
        </div>
      </div>
