    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden bg-navy">
      ...
      <div className="relative z-10 w-full max-w-md p-6 sm:p-8 md:p-10 bg-black/30 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl animate-in fade-in zoom-in-95 duration-500 mx-4 sm:mx-0">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <Button 
                type="submit" 
                className="w-full h-12 bg-gradient-to-r from-gold to-amber-500 hover:from-amber-400 hover:to-gold text-navy font-black text-lg rounded-xl shadow-lg shadow-gold/10 hover:shadow-gold/20 hover:-translate-y-0.5 transition-all duration-500 ease-out" 
                isLoading={isLoading}
            >
              {t('submit')}
            </Button>
