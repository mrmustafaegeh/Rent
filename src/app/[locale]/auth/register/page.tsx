        ...
        <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="grid grid-cols-2 gap-4">
                <button
                    ...
                    className="flex items-center justify-center gap-3 px-4 py-3 border border-white/10 rounded-xl bg-white/5 hover:bg-white/10 transition-all hover:-translate-y-0.5 text-white text-sm font-bold group"
                >
